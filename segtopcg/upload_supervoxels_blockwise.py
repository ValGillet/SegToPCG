...
def supervoxel_to_graphene_blockwise(fragments_file, 
    ...
    try:
        ...
        vol = CloudVolume(cloudvolume_path, 
                          info = info, 
                          fill_missing = False,
                          parallel = False,
                          progress = False)
        ...
        logging.info(f'CloudVolume inialized at path: {cloudvolume_path}')
...
if __name__ == '__main__':
    ...
    upload_supervoxels_blockwise(**config)
