...
def connected_components_to_cloud(chunk_coord,
    ...
    print(f'chunk_coord: {chunk_coord}')
    ...
    # Download edges
    main_edges = get_chunk_edges(edges_dir, [main_chunk])
    ...
    # Mask out any edge connecting chunk to interface
        ...
        for chunk, adj_threshold in zip(adj_chunks, thresholds_adj):
            # Threshold needs to be whatever is the maximum between main_chunk and adj_chunk
            ...
            adj_edges = get_chunk_edges(edges_dir, [chunk])
